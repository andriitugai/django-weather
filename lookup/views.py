...
def home(request):
    ...
    api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=json&zipCode=89129&distance=5&API_KEY=C621724F-00B6-42C0-81C7-490E58F4E8FC")
